...
{
    public class ExecuteQueryV1RequestTests
    {
        [Fact]
        public void Constructor_ValidQuery_CreatesRequest()
        {
            ...
            // Act
            var request = new ExecuteQueryV1Request(query);

            // Assert
            Assert.Equal(query, request.Query);
            Assert.Equal(StatementApiVersion.V1, request.ApiVersion);
        }
        ...
        public void Constructor_NullQuery_ThrowsException()
        {
            ...
            // Act & Assert
            Assert.Throws<ArgumentNullException>(() => new ExecuteQueryV1Request(query));
        }
        ...
        public void Constructor_WithOptions_SetsOptions()
        {
            ...
            // Act
            var request = new ExecuteQueryV1Request(query, options);
